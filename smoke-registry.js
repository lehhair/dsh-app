...
if (a.isDefault !== true || b.isDefault !== false) throw new Error('default init wrong')
...
// set default
reg.setDefault(b.id)
if (!reg.find(b.id).isDefault || reg.find(a.id).isDefault) throw new Error('setDefault failed')
// remove
reg.remove(a.id)
